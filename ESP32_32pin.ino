...
// int checkDeg(int userMoist, int sensorMoist){
//   int temp = userMoist-sensorMoist;
//   int mapped = map(temp,userMoist, sensorMoist,0,100);
//   return temp;
// }
